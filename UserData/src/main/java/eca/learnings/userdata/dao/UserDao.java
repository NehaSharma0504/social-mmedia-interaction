package eca.learnings.userdata.dao;
...
public class UserDao {
    ...
    @Autowired
    public UserDao(@Value("${spring.data.mongodb.uri}") String mongoUri, @Value("${collection.name}") String collectionName) {
    ...
    public User getUserById(String userId, String collectionName) {
        Document doc = database.getCollection(collectionName).find(new Document("userId", userId)).first();
